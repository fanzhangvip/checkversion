...
public class DownloadProgressButton extends TextView {
    ...
    //继续背景颜色
    private int mBackgroundContinueColor;
    //继续文字颜色
    private int mTextContinueColor;
    ...
    public static final int STATE_CONTINUE = 5;//询问后,继续
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBackgroundErrorColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_error_color, Color.RED);
            mTextErrorColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_text_error_color, Color.WHITE);
            mBackgroundContinueColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_continue_color, Color.parseColor("#009933"));
            mTextContinueColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_text_continue_color, Color.WHITE);
    ...
    private void drawBackground(Canvas canvas) {
        ...
        switch (mState) {
            ...
            case STATE_ERROR:
                ...
                mBackgroundPaint.setColor(mBackgroundErrorColor);
                canvas.drawRoundRect(rectF, mButtonRadius, mButtonRadius, mBackgroundPaint);
                break;
            case STATE_CONTINUE:
                ...
                rectF1.left = 0;
                rectF1.top = 0;
                rectF1.right = getMeasuredWidth();
                rectF1.bottom = getMeasuredHeight();
                mBackgroundPaint.setColor(mBackgroundContinueColor);
                canvas.drawRoundRect(rectF1, mButtonRadius, mButtonRadius, mBackgroundPaint);
                break;
        }
    }
    ...
    private void drawTextAbove(Canvas canvas) {
        ...
        switch (mState) {
            ...
            case STATE_ERROR:
                ...
                break;
            case STATE_CONTINUE:
                mTextPaint.setColor(mTextContinueColor);
                canvas.drawText(mCurrentText.toString(), (getMeasuredWidth() - textWidth) / 2, y, mTextPaint);
                break;
        }
